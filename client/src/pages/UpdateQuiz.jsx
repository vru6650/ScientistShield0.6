...
export default function UpdateQuiz() {
    ...
    return (
        <div className='p-3 max-w-4xl mx-auto min-h-screen bg-neutral dark:bg-neutral text-text dark:text-muted'>
            <h1 className='text-center text-4xl my-8 font-extrabold text-text dark:text-white'>Update Quiz</h1>
            <form className='flex flex-col gap-6 p-6 bg-white dark:bg-neutral rounded-lg shadow-lg' onSubmit={handleSubmit}>
                ...
                {state.formData.questions.map((question, qIndex) => (
                    <div key={question._id || `new-q-${qIndex}`} className="border border-blue-300 dark:border-blue-700 p-5 rounded-lg bg-primary dark:bg-primary/10 relative mb-4 shadow-sm">
